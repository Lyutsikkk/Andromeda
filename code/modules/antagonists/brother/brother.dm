...
/datum/antagonist/brother/get_preview_icon()
	...
	brother1.dna.features[FEATURE_ETHEREAL_COLOR] = GLOB.color_list_ethereal["Слабый красный"]
	brother1.set_species(/datum/species/ethereal)

	brother2.dna.features[FEATURE_MOTH_ANTENNAE] = "Обычные"
	brother2.dna.features[FEATURE_MOTH_MARKINGS] = "Ничего"
	brother2.dna.features[FEATURE_MOTH_WINGS] = "Обычные"
