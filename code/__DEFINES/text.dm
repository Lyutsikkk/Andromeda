...
#define MAPTEXT_PIXELLARI(text) {"<span style='font-family: \"Pix Cyrillic\"; font-size: 12pt; -dm-text-outline: 1px black'>[##text]</span>"} /// ANDROMEDA EDITED - Кириллица (Old: #define MAPTEXT_PIXELLARI(text) {"<span style='font-family: \"Pixellari\"; font-size: 12pt; -dm-text-outline: 1px black'>[##text]</span>"})
